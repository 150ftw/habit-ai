...
## 🚀 How to Deploy
The project can be deployed to [Vercel](https://vercel.com) or any static hosting provider.

## 🚀 Live Demo
The project is already deployed @ [Habit AI](https://habit-ai-two.vercel.app)
